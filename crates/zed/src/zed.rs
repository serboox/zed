...
use db_client_ui::DatabasePanel;
...
fn register_actions(
    ...
    workspace
        ...
        .register_action(
            |workspace: &mut Workspace,
             _: &zed_actions::database_panel::ToggleFocus,
             window: &mut Window,
             cx: &mut Context<Workspace>| {
        ...
        .register_action(
            |workspace: &mut Workspace,
             _: &zed_actions::database_panel::ExecuteToFile,
             window: &mut Window,
             cx: &mut Context<Workspace>| {
                db_client_ui::execute_current_sql_query_to_file(workspace, window, cx);
            },
        )
        .register_action(
            |workspace: &mut Workspace,
             _: &zed_actions::database_panel::SaveRunConfiguration,
             window: &mut Window,
             cx: &mut Context<Workspace>| {
                db_client_ui::save_run_configuration(workspace, window, cx);
            },
        )
        .register_action(
            |workspace: &mut Workspace,
             _: &zed_actions::database_panel::RunSqlFile,
             window: &mut Window,
             cx: &mut Context<Workspace>| {
...
mod tests {
    ...
    use gpui::{
        ...
        TestAppContext, UpdateGlobal, VisualTestContext, WindowHandle, actions, point, px, size,
    };
