...
/// above any a running server would be assigned, and one apart from the
/// compiler's.
const RUFF_SERVER_ID: language::LanguageServerId = language::LanguageServerId(usize::MAX - 1002);
