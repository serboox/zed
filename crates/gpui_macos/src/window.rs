...
/// read where they are. A drag re-entering the window it started from is
/// always a move, the same as the app explicitly claiming the drag.
fn what_this_window_does_with_a_drag(this: &Object, is_source_window: bool) -> NSDragOperation {
    let window_state = unsafe { get_window_state(this) };
    let takes = window_state.as_ref().lock().takes_the_drag;
    match takes || is_source_window {
...
extern "C" fn dragging_entered(this: &Object, _: Sel, dragging_info: id) -> NSDragOperation {
    ...
    {
        return what_this_window_does_with_a_drag(this, is_source_window);
    }
    NSDragOperationNone
}
...
extern "C" fn dragging_updated(this: &Object, _: Sel, dragging_info: id) -> NSDragOperation {
    ...
    if send_file_drop_event(window_state, FileDropEvent::Pending { position }) {
        what_this_window_does_with_a_drag(this, is_source_window)
    } else {
        NSDragOperationNone
    }
}
