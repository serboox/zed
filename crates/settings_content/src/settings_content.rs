...
pub struct TypoDiagnosticsSettingsContent {
    /// Whether a misspelling in a name or a comment is reported, as advice
    /// rather than as a fault. Off means nothing is read and nothing is
    /// shown.
    ///
    /// Default: true
    pub enabled: Option<bool>,
