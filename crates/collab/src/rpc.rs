...
impl Server {
    pub fn new(id: ServerId, app_state: Arc<AppState>) -> Arc<Self> {
        ...
        server
            ...
            .add_request_handler(forward_read_only_project_request::<proto::PrepareCallHierarchy>)
            .add_request_handler(forward_read_only_project_request::<proto::CallHierarchyCalls>)
            .add_request_handler(forward_read_only_project_request::<proto::PrepareTypeHierarchy>)
            .add_request_handler(forward_read_only_project_request::<proto::TypeHierarchyRelatives>)
