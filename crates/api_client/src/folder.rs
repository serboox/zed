...
pub struct Folder {
    ...
    ///
    /// Held on the folder as well as on each request under it, rather than
    /// worked out from them: a folder with nothing in it can be deprecated
    /// too, and a request moved into a deprecated folder should keep whatever
    /// it was marked as until someone says otherwise.
    #[serde(default)]
    pub deprecated: bool,
}
